  ...
  return (
    <div className="flex items-center space-x-16 my-8 md:my-0 justify-center">
      ...
      <Link href="https://www.github.com/in/sridesigns">
        <a target="_blank" rel="noopener noreferrer" className="cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-gray-900 dark:text-gray-50 fill-current transform hover:scale-110" viewBox="0 0 40 40" >
