          ...
          <div className="flex flex-row col-span-1 space-x-8 items-center justify-end">
            ...
            <Link href="mailto:msgsrive@gmail.com">
              <a target="_blank" rel="noopener noreferrer" className="cursor-pointer">
                <svg className="w-5 h-5 text-gray-800 hover:text-indigo-600 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg>
              </a>
            </Link>

            <Link href="https://twitter.com/designersriram">
              <a>
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-gray-800 fill-current hover:text-twitter" viewBox="0 0 24 24"><path d="M24 4.557a9.83 9.83 0 01-2.828.775 4.932 4.932 0 002.165-2.724 9.864 9.864 0 01-3.127 1.195 4.916 4.916 0 00-3.594-1.555c-3.179 0-5.515 2.966-4.797 6.045A13.978 13.978 0 011.671 3.149a4.93 4.93 0 001.523 6.574 4.903 4.903 0 01-2.229-.616c-.054 2.281 1.581 4.415 3.949 4.89a4.935 4.935 0 01-2.224.084 4.928 4.928 0 004.6 3.419A9.9 9.9 0 010 19.54a13.94 13.94 0 007.548 2.212c9.142 0 14.307-7.721 13.995-14.646A10.025 10.025 0 0024 4.557z" />
                </svg>
              </a>
            </Link>
