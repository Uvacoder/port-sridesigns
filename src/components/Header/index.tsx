          ...
          <div className="col-span-2 flex flex-row space-x-24 items-center justify-center">
            {
              defaultRoutes.map((route) => {
                ...
                const inactiveLinks = `hover:text-indigo-600 dark:hover:text-sky-400 filter-saturate`
                return (
                  <Link href={route.path} key={route.path}>
                    <a
                      className={`
          ...
          <div className="flex flex-row col-span-1 space-x-12 items-center justify-end">
            ...
            <Link href="mailto:msgsrive@gmail.com">
              <a target="_blank" rel="noopener noreferrer" className="cursor-pointer">
                <svg className="w-5 h-5 text-gray-900 dark:text-gray-100 hover:text-indigo-600 dark:hover:text-sky-400 fill-current transform hover:scale-110" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg>
              </a>
            </Link>
